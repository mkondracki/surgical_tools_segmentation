...
def construct_optimizer(
    ...
    # If validate_param_groups is False, peft is activated and we need to
    # store in the optimizer non-trainable parameters
    named_parameters = {
        name: param
        for name, param in model.named_parameters()
        # if name in param_allowlist and (not validate_param_groups or param.requires_grad)
